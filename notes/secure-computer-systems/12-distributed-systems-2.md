...
Assume we have some sensitive file called "Budget". We might have an access control rule: *SRC-Node as Accounting as bwl-user can read Budget*
...
The server's ACL is given previously as *SRC-Node as Accounting as bwl-user can read Budget*.
