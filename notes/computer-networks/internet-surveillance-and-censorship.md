...
Researchers have tried to reverse engineer the GFW and to understand how it works. Based on the research paper [Towards a Comprehensive Picture of the Great Firewall's DNS Censorship](https://www.usenix.org/system/files/conference/foci14/foci14-anonymous.pdf), researchers have started to identify some of the properties:
