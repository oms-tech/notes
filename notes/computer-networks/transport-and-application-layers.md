...
`1/p = (w/2)2 + 1/2*(w/2)2 = 3/8*W2`, solving for `W =` ![](https://assets.omscs-notes.com/images/notes/computer-networks/0050.svg)
...
We can collect all of our constants into ![](https://assets.omscs-notes.com/images/notes/computer-networks/0052.svg), compute the throughput:
