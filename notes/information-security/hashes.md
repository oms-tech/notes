...
![](https://assets.omscs-notes.com/images/notes/information-security/199B4A9A-827F-427B-9D14-4A453A38889B.png)
...
The third person, $t$, is in a similar situation. Since two people precede them, there are only 363 available birthdays left. As a result, $p$ drops to $364 / 365 \times 363 / 365$. We multiply the probabilities because we need to make sure that $s$ doesn't violate the uniqueness constraint *and* $t$ doesn't either. Technically, this is a conditional probability.
...
![](https://assets.omscs-notes.com/images/notes/information-security/68F165A1-0C6B-44D3-86DB-304093AF2695.png)
