...
Assume we have a pandas DataFrame containing historical features of a particular
...
We can then select our historical $X$ and $Y$ values, scoped by the constraints
